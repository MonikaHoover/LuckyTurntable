...
class OptionController: BaseController {
    ...
    private lazy var tableView = { () -> UITableView in
        ...
        tab.delegate = self
        tab.dataSource = self
        tab.register(OptionCell.self, forCellReuseIdentifier: OptionCell.identifier)
    ...
    override func viewDidLoad() {
        ...
        self.addCellEndLucky("Lucj:uusec")
...
extension OptionController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: OptionCell.identifier) as? OptionCell
        if cell == nil {
            cell = OptionCell.init(style: .default, reuseIdentifier: OptionCell.identifier)
        }
...
extension OptionController: OptionCellDelegate{
