...
class SettingController: BaseController,MFMailComposeViewControllerDelegate {
    ...
    private let dataAry = [[SettingType.music("Voice", AppConfig.makeAppConfig().isOpenMusic),
    ...
    override func viewDidLoad() {
        ...
        headline = "Setting"
        self.viewDidLoadKQSuLucky("setting")
    }
}
extension SettingController: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .closeAd(_):
            ...
            let url = "http://itunes.apple.com/app/id" + "123"
            ...
            break;
        case .evaluation(_):
            let openUrl = "itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=1470915060"
