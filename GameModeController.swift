...
enum GameMode: String {
    case Lottery = "Lucky Turntable"
    case Random = "Random Pattern"
    case Scrath = "Scratch Ticket"
}
class GameModeController: BaseController {
    ...
    override func viewDidLoad() {
        ...
        btn1.tag = 102
        self.startGameEFZVnLucky("success", btn: btn1)
