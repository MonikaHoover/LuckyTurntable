...
class BaseController: UIViewController {
    private let titleL = UILabel.createLabel(title: "GAME MODES", color: .white, font: 44, textAlignment: .center, backColor: .clear, numberOfLines: 1)
    ...
    override func viewDidLoad() {
        ...
        self.clickRightBtnHBKoOLucky("lucky:success")
        titleL.addShadow()
